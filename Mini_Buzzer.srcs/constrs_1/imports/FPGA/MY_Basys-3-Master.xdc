...
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports { o_buzzer }]; #IO_L3P_T0_DQS_AD5P_35 ,Sch=JA7
...
# set_property -dict { PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports { o_clk }]; #IO_L6P_T0_16       ,Sch=JB1
